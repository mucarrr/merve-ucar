...
export const metadata: Metadata = {
  ...
  title:
    "Merve Uçar - Freelance Frontend, Backend & Full Stack Developer | Website & Mobile App Developer | Yazılım Geliştirici",
  description:
  ...
  keywords: [
    ...
    // Full Stack - TR
    "Freelance Full Stack Geliştirici",
    ...
    "Angular Developer",
    // Frontend - TR
    "Freelance Frontend Geliştirici",
    "Frontend Geliştirici",
    "Frontend Yazılım Geliştirici",
    "React Geliştirici",
    "Next.js Geliştirici",
    "UI Geliştirici",
    "Frontend Developer",
    ...
    "Website Geliştirici",
    "Website Geliştirme",
    "Website Tasarım Geliştirici",
    "Özel Website Geliştirme",
    "Website Developer",
    "Website Development",
    "Website Hizmetleri",
    ...
    "Mobil Uygulama Developer",
    "Freelance Mobil Geliştirici",
    "Mobil Geliştirici İşe Al",
    "iOS Geliştirici",
    "Android Geliştirici",
    ...
    "Mobil Uygulama Geliştirme",
    "Cross-platform Mobil Geliştirici",
    "Mobile App Developer",
    "Mobile Application Developer",
    "Freelance Mobile Developer",
  ],
