...
export const metadata: Metadata = {
  ...
  title:
    "Experience - Merve Uçar | Work Experience & Professional Background | Full Stack Developer",
  description:
  ...
  openGraph: {
    ...
    description:
      "My professional work experience and background in web development. MERN Stack, React, Next.js experience.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Experience - Merve Uçar | Professional Background",
    description:
      "Professional work experience in web development. MERN Stack, React, Next.js experience.",
    images: ["/favicon.svg"],
  },
  alternates: {
