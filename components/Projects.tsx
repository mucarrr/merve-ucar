...
export default function Projects() {
  ...
  const turkishTranslations: {
    [key: string]: { title: string; description: string; longDescription: string };
  } = {
    "Premium Car Rental Service": {
      title: "Premium Araç Kiralama Hizmeti",
      description: "Kolay rezervasyon ve güvenli ödemeli modern araç kiralama platformu",
      longDescription:
        "TypeScript ile geliştirilmiş modern araç kiralama platformu. Kullanıcılar kolayca araç arayabilir, rezervasyon yapabilir ve güvenli ödeme gerçekleştirebilir. Responsive tasarım ve kullanıcı dostu arayüz.",
    },
    "Smart QR Menu System": {
      title: "Akıllı QR Menü Sistemi",
      description: "QR kod teknolojisi ile temassız dijital menü sistemi",
      longDescription:
        "QR kod teknolojisi kullanarak restoranların dijital menü sistemini oluşturan uygulama. Müşteriler QR kod okutarak menüyü görüntüleyebilir ve sipariş verebilir. Temassız hizmet deneyimi sunar.",
    },
    "Complete Restaurant Management": {
      title: "Komple Restoran Yönetimi",
      description: "Stok ve müşteri takipli kapsamlı restoran yönetim sistemi",
      longDescription:
        "Restoranlar için geliştirilmiş kapsamlı yönetim sistemi. Sipariş yönetimi, stok takibi, müşteri veritabanı ve raporlama özellikleri içerir. Modern web teknolojileri ile geliştirildi.",
    },
    "Property Search Platform": {
      title: "Emlak Arama Platformu",
      description: "Akıllı arama ve gelişmiş filtreleme ile emlak platformu",
      longDescription:
        "Emlak sektörü için geliştirilmiş modern platform. Akıllı arama algoritmaları, gelişmiş filtreleme seçenekleri ve harita entegrasyonu ile kullanıcıların ideal evlerini bulmasını kolaylaştırır.",
    },
    "Modern E-commerce Store": {
      title: "Modern E-ticaret Mağazası",
      description: "Güvenli ödeme ve hızlı teslimat ile tam donanımlı online mağaza",
      longDescription:
        "Modern e-ticaret deneyimi sunan kapsamlı online mağaza. Güvenli ödeme sistemleri, stok yönetimi, kullanıcı hesapları ve sipariş takibi özellikleri ile tam donanımlı e-ticaret çözümü.",
    },
    "Interactive Learning Platform": {
      title: "İnteraktif Öğrenme Platformu",
      description: "İnteraktif dersler ve ilerleme takipli online eğitim platformu",
      longDescription:
        "Öğrenciler ve eğitmenler için tasarlanmış kapsamlı online eğitim platformu. Video dersler, quizler, ödev sistemi ve detaylı ilerleme raporları ile modern eğitim deneyimi sunar.",
    },
    "Ice Cream Business Manager": {
      ...
      longDescription:
        "Dondurma dükkanları için özel olarak tasarlanmış yönetim sistemi. Ürün kataloğu, sipariş yönetimi, müşteri takibi ve satış raporları ile işletme verimliliğini artırır.",
    },
    "Premium Shoe Store": {
      title: "Premium Ayakkabı Mağazası",
      description: "Gelişmiş filtrelerle modern ayakkabı alışveriş deneyimi",
      longDescription:
        "Ayakkabı severler için tasarlanmış modern e-ticaret platformu. Gelişmiş filtreleme, ürün karşılaştırma ve güvenli ödeme seçenekleri ile mükemmel alışveriş deneyimi sunar.",
    },
    "Professional Tech Services": {
      title: "Profesyonel Teknoloji Hizmetleri",
      description: "Teknoloji hizmet şirketleri için kurumsal web sitesi",
      longDescription:
        "Teknoloji şirketleri için profesyonel kurumsal web sitesi. Hizmet tanıtımları, proje portföyü, iletişim formları ve modern tasarım ile güvenilir kurumsal imaj oluşturur.",
    },
    "Fast Food Delivery App": {
      title: "Hızlı Yemek Teslimat Uygulaması",
      description: "Gerçek zamanlı takip ve hızlı teslimatla yemek sipariş platformu",
      longDescription:
        "Restoranlar ve müşteriler arasında köprü kuran yemek sipariş platformu. Gerçek zamanlı sipariş takibi, güvenli ödeme ve hızlı teslimat seçenekleri ile modern yemek sipariş deneyimi.",
    },
    "Smart Hotel Reservation": {
      ...
      longDescription:
        "Otel işletmeleri için geliştirilmiş rezervasyon yönetim sistemi. Oda müsaitlik takibi, dinamik fiyatlandırma, müşteri yönetimi ve detaylı raporlama özellikleri ile kapsamlı çözüm.",
    },
    "Video Sharing Network": {
      title: "Video Paylaşım Ağı",
      description: "YouTube benzeri modern arayüzlü video platformu",
      longDescription:
        "YouTube benzeri video paylaşım ve izleme platformu. Video yükleme, kategorilere ayırma, beğeni/yorum sistemi ve kullanıcı kanalları ile kapsamlı video deneyimi sunar.",
    },
    "Travel Map API Service": {
      title: "Seyahat Haritası API Servisi",
      description: "Konum ve rota yönetimi için backend servisi",
      longDescription:
        "Seyahat uygulamaları için geliştirilmiş backend servisi. Konum veritabanı, rota hesaplama, gezi planlama ve kullanıcı etkileşimleri için API servisleri sunar.",
    },
    "Live Chat Messenger": {
      title: "Canlı Sohbet Messenger",
      description: "WebSocket teknolojisi ile gerçek zamanlı mesajlaşma",
      longDescription:
        "WebSocket teknolojisi kullanarak geliştirilmiş gerçek zamanlı mesajlaşma uygulaması. Anlık mesaj gönderimi, grup sohbetleri, dosya paylaşımı ve kullanıcı durumu takibi özellikleri.",
    },
    "Social Recipe Network": {
      title: "Sosyal Tarif Ağı",
      description: "Sosyal özelliklerle tarif paylaşım platformu",
      longDescription:
        "Yemek severler için tasarlanmış tarif paylaşım platformu. Tarif yayınlama, kategorilere ayırma, beğeni sistemi, yorumlar ve kullanıcı profilleri ile sosyal yemek deneyimi.",
    },
    "COVID-19 Data Tracker": {
      title: "COVID-19 Veri Takipçisi",
      description: "Gerçek zamanlı pandemi verisi görselleştirme haritası",
      longDescription:
        "COVID-19 salgın verilerini görselleştiren interaktif harita uygulaması. Gerçek zamanlı veri güncellemeleri, bölgesel istatistikler ve trend analizleri ile kapsamlı salgın takibi.",
    },
    "Business Admin Panel": {
      title: "İşletme Yönetim Paneli",
      description: "Analitik ve raporlamalı kapsamlı yönetim paneli",
      longDescription:
        "İşletmeler için geliştirilmiş kapsamlı yönetim paneli. Kullanıcı yönetimi, veri analizi, raporlama, sistem ayarları ve gerçek zamanlı dashboard ile tam kontrol sağlar.",
    },
    "React Shopping Store": {
      title: "React Alışveriş Mağazası",
      description: "Kusursuz kullanıcı deneyimli modern e-ticaret",
      longDescription:
        "React teknolojisi ile geliştirilmiş modern e-ticaret mağazası. Responsive tasarım, hızlı yükleme, güvenli ödeme ve kullanıcı dostu arayüz ile mükemmel alışveriş deneyimi.",
    },
    "Online Bookstore Hub": {
      title: "Online Kitap Mağazası Merkezi",
      description: "Akıllı önerilerle kitap pazarı",
      longDescription:
        "Kitap severler için tasarlanmış kapsamlı online mağaza. Geniş kitap kataloğu, akıllı öneri sistemi, yazar bilgileri ve kullanıcı yorumları ile zengin kitap alışveriş deneyimi.",
    },
  };
  ...
  const translatedPreview = previewProject
    ? getTranslatedProject(previewProject, currentLanguage)
    : null;
            ...
            >
              <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl max-w-3xl w-full max-h-[85vh] overflow-auto border border-amber-200/30 dark:border-amber-700/30">
                ...
                {previewProject.image && (
                  <div
                    className="w-full h-64 md:h-80 bg-gray-100 dark:bg-gray-800"
                    style={{ aspectRatio: "16/9" }}
                  >
                    <img
